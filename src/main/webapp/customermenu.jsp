...
<body>
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="container">
        ...
        <button class="btn btn-lg btn-register"><a href="addcustomer" class="text-white"/> Register</button>
        <br><br>
        <br>
        <button class="btn btn-lg btn-login"><a href="customerloginform.jsp" class="text-white"/>Login</button>
    </div>
